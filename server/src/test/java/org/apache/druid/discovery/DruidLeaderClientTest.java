...
public class DruidLeaderClientTest extends BaseJettyTest
{
  ...
  {
    final DruidNode node = new DruidNode("test", "localhost", false, null, null, true, false, "invalid", false);
  ...
  public void testServerFailureAndRedirect() throws Exception
  {
    ...
    DiscoveryDruidNode dummyNode = new DiscoveryDruidNode(
        new DruidNode("test", "dummyhost", false, 64231, null, true, false, "invalid", false),
        NodeRole.PEON,
        ImmutableMap.of()
    );
