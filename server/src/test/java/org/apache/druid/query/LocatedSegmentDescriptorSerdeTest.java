...
public class LocatedSegmentDescriptorSerdeTest
{
  ...
  public void testDimensionsSpecSerde() throws Exception
  {
    LocatedSegmentDescriptor expected = new LocatedSegmentDescriptor(
        ...
        65535,
        Arrays.asList(
            new DruidServerMetadata("server1", "host1", null, 30000L, ServerType.HISTORICAL, "tier1", 0, "rack"),
            new DruidServerMetadata("server2", "host2", null, 40000L, ServerType.HISTORICAL, "tier1", 1, "rack"),
            new DruidServerMetadata("server3", "host3", null, 50000L, ServerType.REALTIME, "tier2", 2, "rack")
        )
    );
