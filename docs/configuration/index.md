...
|`druid.coordinator.guildReplication.on`| Boolean flag for whether of not the Coordinator should attempt to load and balance segments in a way that results in segments being loaded onto two or more guilds.|false|
...
```json
{
  ...
  "guildREplicationMaxPercentOfMaxSegmentsToMove": 50,
